export const posts = [
    ...
    {
        slug: 'javier',
        title: 'Mono se escapa del zoo',
        content: "<p>Hemos recibido informes de un mono llamado javier que se ha escapado del zoo, urgimos a todos los residentes a buscar un refugio hasta nuevo aviso. Que dios les guarde.</p>"    
    }
];
